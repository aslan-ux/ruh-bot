...
(function () {
  ...
  css.textContent = [
    ...
    "#rxSet{color:var(--text,#17171F)}",
    "#rxSet .rx-srow{color:var(--text,#17171F)}",
    "#rxSet .rx-srow:active{background:rgba(127,127,127,.10)}",
    ".rx-conf button[data-a=no]{color:var(--text,#17171F)}",
    "#rxSet .rx-srow + .rx-srow{border-top:1px solid rgba(127,127,127,.16)}",
